...
class NamesControllerTest < ActionController::TestCase
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post :create, name: { description: @name.description, female: @name.female, male: @name.male, name: @name.name, shot: @name.shot }
    end
  ...
  test "should update name" do
    patch :update, id: @name, name: { description: @name.description, female: @name.female, male: @name.male, name: @name.name, shot: @name.shot }
    assert_redirected_to name_path(assigns(:name))
  end
